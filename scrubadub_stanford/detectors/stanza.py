...
This detector requires Java 1.8+ and the Stanford CoreNLP installation is around 500MB. 
...
class StanfordEntityDetectorStanza(Detector):
    ...
    >>> detector = scrubadub_stanford.detectors.StanfordEntityDetectorStanza(
    ...
    def __init__(self, enable_person: bool = True, enable_organization: bool = True, enable_location: bool = False, 
        ...
        super(StanfordEntityDetectorStanza, self).__init__(**kwargs)

    def _check_downloaded(self, dir: str = DEFAULT_CORENLP_DIR):
        """Check for a downloaded Stanford CoreNLP Client.
    ...
    def _download(self, dir: str = DEFAULT_CORENLP_DIR):
        """Download and install CoreNLP Client to the specified directory. 
...
register_detector(StanfordEntityDetectorStanza)

__all__ = ["StanfordEntityDetectorStanza"]
